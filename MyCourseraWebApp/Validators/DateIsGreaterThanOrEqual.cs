...
namespace MyCourseraWebApp.Validators
{
    ...
    public class DateIsGreaterThanOrEqualAttribute : ValidationAttribute, IClientValidatable
    {
        private string otherPropertyName;

        public DateIsGreaterThanOrEqualAttribute(string otherPropertyName, string errorMessage)
            : base(errorMessage)
        {
        ...
        public IEnumerable<ModelClientValidationRule> GetClientValidationRules(ModelMetadata metadata, ControllerContext context)
        {
            ...
            dateIsGreaterThanRule.ValidationType = "dateisgreaterthanorequal";
