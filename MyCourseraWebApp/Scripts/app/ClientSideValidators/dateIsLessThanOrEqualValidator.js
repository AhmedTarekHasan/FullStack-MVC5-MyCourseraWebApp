...
$.validator.addMethod("dateislessthanorequal", function (value, element, params) {
    var result = true;
...
$.validator.unobtrusive.adapters.add("dateislessthanorequal", ["otherpropertyname"], function (options) {
    options.rules["dateislessthanorequal"] = "#" + options.params.otherpropertyname;
    options.messages["dateislessthanorequal"] = options.message;
});
