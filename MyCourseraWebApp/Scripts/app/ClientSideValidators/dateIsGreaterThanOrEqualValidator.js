...
$.validator.addMethod("dateisgreaterthanorequal", function (value, element, params) {
    var result = true;
        ...
        if (typeof (value) != 'undefined' && value != null && value != '') {
            ...
            if (typeof (temp) != 'undefined' && temp != null && temp != '') {
                ...
                if (typeof (params) != "undefined" && params != null && params != "") {
                    ...
                    if (typeof (otherInput) != "undefined" && otherInput != null) {
                        var otherValue = otherInput.val();

                        if (typeof (otherValue) != "undefined" && otherValue != null && otherValue != '') {
                            temp = Date.parse(otherValue);

                            if (typeof (temp) != "undefined" && temp != null && temp != '') {
                                var date2 = new Date(otherValue);
...
$.validator.unobtrusive.adapters.add("dateisgreaterthanorequal", ["otherpropertyname"], function (options) {
    options.rules["dateisgreaterthanorequal"] = "#" + options.params.otherpropertyname;
    options.messages["dateisgreaterthanorequal"] = options.message;
});
